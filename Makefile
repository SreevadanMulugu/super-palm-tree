.PHONY: all build clean install rpm test release ci-push
...
help:
	...
	@echo "  make ci-push      - Push current branch to origin"
	@echo "  make release      - Tag and push v$(VERSION) to trigger GitHub Actions release"

# Push current branch to GitHub (triggers CI builds on main/master or PRs)
ci-push:
	@git push origin HEAD

# Create and push a version tag to trigger cross-OS builds and release
release:
